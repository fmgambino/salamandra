-- Salamandra IoT Supabase Schema v05 corregido
-- Ejecutable: corrige error 42P16 usando DROP VIEW antes de recrear vistas.
-- Basado en tu esquema actual de Supabase (profiles, devices, sensors, actuators, readings, tickets, inventory).
